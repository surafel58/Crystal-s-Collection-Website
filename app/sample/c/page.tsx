    ...
    <div className="space-y-32 pb-32">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative container h-full mx-auto px-4 md:px-6 flex flex-col items-center justify-center text-center z-10">
           <span className="text-yellow-500 text-sm font-bold tracking-[0.3em] uppercase mb-6 animate-fade-in">Exquisite Collection</span>
           ...
           <Button asChild size="lg" className="rounded-sm bg-yellow-500 text-slate-950 hover:bg-yellow-400 px-10 py-6 text-sm font-bold tracking-widest uppercase">
      ...
      <section className="container px-4 md:px-6 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {featuredProducts.map((product) => (
            <Link href={`/sample/c/product/${product.id}`} key={product.id} className="group relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                   ...
                   <div className="flex items-center justify-between mt-4">
                     ...
                     <Button 
                       size="sm"
                       variant="outline"
                       className="border-yellow-500 text-yellow-500 hover:bg-yellow-500 hover:text-slate-950 uppercase text-[10px] tracking-widest opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0"
        ...
        <div className="flex justify-center mt-16">
           <Button asChild variant="outline" className="border-slate-700 text-slate-300 hover:bg-yellow-500 hover:text-slate-950 hover:border-yellow-500 rounded-sm px-8 tracking-widest uppercase text-xs h-12">
      ...
      <section className="bg-slate-900 py-24 border-y border-slate-800">
        <div className="container px-4 md:px-6 mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1 relative aspect-square bg-slate-950 border border-slate-800 p-4">
          ...
          <div className="order-1 md:order-2 space-y-8">
             ...
             <Button asChild className="rounded-sm bg-white text-slate-950 hover:bg-slate-200 px-8 py-6 text-xs font-bold tracking-widest uppercase">
